...
class TestWorkflowLaunchForm:
    """Tests for WorkflowLaunchForm schema."""
    ...
    def test_pipeline_cannot_be_empty(self):
...
class TestWorkflowLaunchPayload:
    """Tests for WorkflowLaunchPayload schema."""
    ...
    def test_valid_payload_with_dataset_id(self):
...
class TestWorkflowLaunchResponse:
    """Tests for WorkflowLaunchResponse schema."""
...
class TestCancelWorkflowResponse:
    """Tests for CancelWorkflowResponse schema."""
...
class TestRunInfo:
    """Tests for RunInfo schema."""

    def test_valid_run_info(self):
...
class TestListRunsResponse:
    """Tests for ListRunsResponse schema."""
    ...
    def test_runs_list_with_data(self):
...
class TestLaunchLogs:
    """Tests for LaunchLogs schema."""
...
class TestLaunchDetails:
    """Tests for LaunchDetails schema."""
