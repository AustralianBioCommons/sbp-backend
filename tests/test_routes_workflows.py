...
def test_launch_rejects_unknown_workflow(client: TestClient):
    payload = {
        "launch": {
            "tool": "boltz",
...
def test_launch_missing_repo_url(client: TestClient, app, test_engine):
    ...
    payload = {
        "launch": {"tool": "anyalgo", "workflow": "norepo", "runName": "test-run"},
        "datasetId": "dataset_123",
        "formData": {},
    }
    response = client.post("/api/workflows/launch", json=payload)
...
def test_launch_missing_default_revision(client: TestClient, app, test_engine):
    ...
    payload = {
        "launch": {"tool": "anyalgo", "workflow": "norev", "runName": "test-run"},
        "datasetId": "dataset_123",
        "formData": {},
    }
    response = client.post("/api/workflows/launch", json=payload)
...
def test_launch_proteinfold_success(mock_launch, client: TestClient, test_engine):
    ...
    payload = {
        "launch": {"tool": "alphafold2", "workflow": "proteinfold", "runName": "pf-run-1"},
...
def test_launch_proteinfold_configuration_error(mock_launch, client: TestClient, test_engine):
    ...
    payload = {
        "launch": {"tool": "alphafold2", "workflow": "proteinfold", "runName": "pf-run-cfg-err"},
        "datasetId": "dataset_pf",
        "formData": {},
    }
...
def test_launch_proteinfold_executor_error(mock_launch, client: TestClient, test_engine):
    ...
    payload = {
        "launch": {"tool": "alphafold2", "workflow": "proteinfold", "runName": "pf-run-exec-err"},
        "datasetId": "dataset_pf",
        "formData": {},
    }
...
_LAUNCH_PAYLOAD = {
    "launch": {"tool": "bindcraft", "workflow": "BindCraft", "runName": "role-test-run"},
