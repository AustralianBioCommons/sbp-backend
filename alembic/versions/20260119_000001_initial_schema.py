...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["owner_user_id"], ["app_users.id"], name="workflow_runs_owner_user_id_foreign"
        ),
        sa.ForeignKeyConstraint(
            ["workflow_id"], ["workflows.id"], name="workflow_runs_workflow_id_foreign"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["run_id"], ["workflow_runs.id"], name="run_metrics_run_id_foreign"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["s3_object_id"], ["s3_objects.object_key"], name="run_inputs_s3_object_id_foreign"
        ),
    ...
    op.create_table(
        ...
        sa.Column("s3_object_id", sa.Text(), nullable=False),
        sa.ForeignKeyConstraint(
            ["run_id"], ["workflow_runs.id"], name="run_outputs_run_id_foreign"
        ),
        sa.ForeignKeyConstraint(
            ["s3_object_id"], ["s3_objects.object_key"], name="run_outputs_s3_object_id_foreign"
        ),
