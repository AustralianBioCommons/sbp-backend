...
def require_workflow_execution_role(
    ...
    roles_claim = os.getenv("AUTH0_ROLES_CLAIM", "https://biocommons.org.au/roles")
    required_role = os.getenv("WORKFLOW_EXECUTION_ROLE", "biocommons/group/sbp_workflow_execution")
