...
class JobListItem(BaseModel):
    ...
    workflow: str | None = Field(None, description="Workflow name from the workflows table")
    tool: str | None = Field(None, description="Tool used (e.g., BindCraft); 'Unknown' if not recorded")
